...
namespace GLTFast
{
    ...
    interface IGltfBuffers
    {
        ...
        void GetAccessorDataAndByteStride(int index, out ReadOnlyBuffer<byte> data, out int byteStride);
        ...
        ReadOnlyBuffer<byte> GetBufferView(int bufferViewIndex, out int byteStride, int offset = 0, int length = 0);
    }
}
